...
export function ConciergeSection() {
  return (
    <section
      id="concierge"
      className="relative bg-aqaar-deeper py-24 overflow-hidden"
    >
      {/* Background glow */}
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2">
              {capabilities.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="flex gap-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-aqaar-lime/10">
                    <Icon className="h-4 w-4 text-aqaar-lime" />
                  </div>
                  <div>
          ...
          <div className="relative">
            <div className="rounded-2xl border border-aqaar-line bg-aqaar-card shadow-concierge">
              {/* Header */}
              <div className="relative overflow-hidden rounded-t-2xl border-b border-aqaar-line bg-aqaar-panel px-5 py-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-aqaar-lime">● Online — Ready to assist</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 px-5 py-5">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="rounded-2xl rounded-tl-sm border border-aqaar-line bg-aqaar-panel px-4 py-3 text-sm text-white/80 max-w-[85%]">
                    Excellent! Based on your criteria, I recommend <span className="font-semibold text-aqaar-lime">Mawjan</span> — an 8-10% ROI waterfront development, and <span className="font-semibold text-aqaar-lime">Dusit Thani Residences</span> for a branded luxury option. Shall I provide a detailed comparison?
                  </div>
                </div>

                {/* Recommendation preview card */}
                <div className="rounded-xl border border-aqaar-lime/20 bg-aqaar-lime/5 p-4">
              ...
              <div className="border-t border-aqaar-line px-5 pb-5 pt-4">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-xl bg-aqaar-lime text-aqaar-dark"
                  >
            ...
            {/* Floating stat badge */}
            <div className="absolute -right-4 -top-4 glass rounded-xl border border-aqaar-lime/20 p-3">
